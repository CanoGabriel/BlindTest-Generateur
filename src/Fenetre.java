...
//		IHM1_btn_nom.addActionListener(this);
	...
	private void initIHM1() {
		//Instantiation des diff�rents composants de la fenetre
		...
		//Placement des �l�ments dans leur conteneur
...
//		IHM1_south_l1.add(IHM1_btn_nom, BorderLayout.EAST);
		...
		//Gestion du rendu
		IHM1_txt_titre.		setBorder(BorderFactory.createTitledBorder("Intitul� du site :"));
		IHM1_txt_videoPath.	setBorder(BorderFactory.createTitledBorder("Chemin vers le dossier contenant les videos :"));
		IHM1_txt_nom.		setBorder(BorderFactory.createTitledBorder("R�ponse associ� � la video :"));
		IHM1_txt_audioPath.	setBorder(BorderFactory.createTitledBorder("Chemin vers l'audio de la video associ� � la vid�o :"));
